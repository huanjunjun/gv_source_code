...
/**
 * @brief Entry point for the GVirtuS backend application.
 *
 * This function initializes the logger, sets up the configuration path,
 * and starts the GVirtuS backend process.
 *
 ...
 * 1. Initializes the logger configuration.
 * 2. Logs the GVirtuS backend version.
 * 3. Sets the configuration path based on the command-line arguments or a predefined macro.
 * 4. Logs the configuration path.
 * 5. Attempts to create and start the GVirtuS backend process.
 * 6. Catches and logs any exceptions that occur during the backend process initialization.
 * 7. Logs the shutdown of the process.
 */
